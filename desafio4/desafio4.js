...
function preencherSenha() {
    let passwordElement = document.getElementById('senha');
    if (passwordElement) {
...
function preencherLogin() {
    let usernameElement = document.getElementById('login');
    if (usernameElement) {
...
class HttpClient {
    ...
    static getRequestToken(parameter) {
        return __awaiter(this, void 0, void 0, function* () {
            return new Promise((resolve, reject) => {
                let request = new XMLHttpRequest();
                request.open(parameter.method, parameter.url, true);
...
function procurarFilme(query) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        console.log(query);
        let result = yield HttpClient.getMovie({
...
function criarRequestToken() {
    return __awaiter(this, void 0, void 0, function* () {
        let result = yield HttpClient.getRequestToken({
...
function criarSessao() {
    return __awaiter(this, void 0, void 0, function* () {
        let result = yield HttpClient.getSessionId({
